...
export function getXdrDirectory() {
...
export function validateConfig(input) {
    ...
    return {
        ...
        maximumRows: v.maximumRows,
        schemaTtlHours: v.schemaTtlHours,
...
export async function readStoredConfig(path = getConfigPath()) {
    try {
