...
license: MIT
compatibility: Requires the claude-defender-xdr plugin and an explicit `claude-defender-xdr-login` (or `/defender-xdr:xdr-login`) sign-in, and Defender XDR Advanced Hunting access.
---
