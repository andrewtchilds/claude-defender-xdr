...
license: MIT
compatibility: Requires the claude-defender-xdr plugin and an explicit `claude-defender-xdr-login` (or `/defender-xdr:xdr-login`) sign-in, and access to applicable identity hunting tables.
---
